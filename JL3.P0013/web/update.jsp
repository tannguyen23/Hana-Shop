<%-- 
    Document   : update
    Created on : Jan 19, 2021, 6:22:54 PM
    Author     : tanta
--%>
    ...
    <body>
        <div class="myContainer">
            ...
            <div id="main">
                <div id="main-content">
                    <div id="box">
                        <label id="tittle">Update</label>
                        <form id="formRegister" action="UpdateProductController" method="POST" enctype="multipart/form-data" acceptcharset="UTF-8">
                            <label>Name</label>
                            <input type="hidden" name="productID" value="${productDTO.id}" />
                            <input class="textInput" type="text" name="txtName" value="${productDTO.name}" required=""><br>
                            <label>Quantity</label>
                            <input class="textInput" type="number" name="txtQuantity" value="${productDTO.quantity}" required=""><br>
                            <label>Price</label>
                            <input class="textInput" type="number" name="txtPrice" value="${productDTO.price}" required="" min="1000"><br>
                            <div id="contain-img">
                                <label>Image</label>
                                <input class="fileInput"  type="file" name="fileImage" value="img/${productDTO.image_File_Name}"><br>
                            </div>
                            ...
                            <script>
                                document.getElementById("slCategory").value = "${productDTO.category}";
                                document.getElementById("slStatus").value = "${productDTO.status}";
                            </script>
                            <input id="button" type="submit" name="action" value="Update Product">
                        </form>
