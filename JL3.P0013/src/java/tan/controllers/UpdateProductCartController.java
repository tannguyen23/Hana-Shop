...
public class UpdateProductCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String txtProductQuantity = (String) request.getParameter("productQuantity");
            int productQuantity = Integer.parseInt(txtProductQuantity);
            cartProduct.update(productID, productQuantity);
            session.setAttribute("cartProduct", cartProduct);
            url = SUCCESS;
        } catch (Exception e) {
            log("Error at UpdateProductCartController : " + e.getMessage());
        } finally {
